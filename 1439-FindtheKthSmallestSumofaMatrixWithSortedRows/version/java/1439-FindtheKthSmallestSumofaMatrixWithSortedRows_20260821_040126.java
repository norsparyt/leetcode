// Last updated: 21/08/2026, 04:01:26
// Slight optm. guarantees initialization never exceeds O(k log k) time if the matrix has thousands of columns and k is very small.
1class Solution {
...
15        for(int i = 0; i< Math.min(k,nums1.length); i++){
